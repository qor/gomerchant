...
var (
	...
	ErrUnknownCvsType          = errors.New("gomerchant: unknown cvs type")
	ErrEmptyCustomerFamilyName = errors.New("gomerchant: empty customer family name")
	ErrEmptyCustomerName       = errors.New("gomerchant: empty customer name")
	ErrEmptyCustomerTel        = errors.New("gomerchant: empty customer tel")
)
